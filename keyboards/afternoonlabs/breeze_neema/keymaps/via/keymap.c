...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [_MAIN] =   { ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN), ENCODER_CCW_CW(KC_VOLD, KC_VOLU)  },
    [_LOWER] =  { ENCODER_CCW_CW(KC_RIGHT, KC_RIGHT),           ENCODER_CCW_CW(KC_UP, KC_DOWN)  },
    [_RAISE] =  { ENCODER_CCW_CW(KC_PAGE_UP, KC_PAGE_DOWN),           ENCODER_CCW_CW(KC_PAGE_UP, KC_PAGE_DOWN)  },
    [3] = { ENCODER_CCW_CW(KC_UP, KC_DOWN),          ENCODER_CCW_CW(KC_RIGHT, KC_LEFT) },
};
#endif
